        ...
        public void OnSceneGUI()
        {
           ...
           // dPlane = new Plane3d(spriteDeformerEditor.spriteDeformer.transform.position, spriteDeformerEditor.spriteDeformer.transform.rotation);
            ...
            if (candraw.Contains(spriteDeformerEditor.currentTool))
                Handles.ArrowHandleCap(15, pos2Dto3D(pivot), spriteDeformerEditor.spriteDeformer.transform.rotation * Quaternion.Euler(0 - oriant * Mathf.Rad2Deg, 90, 0), newHandleSize, EventType.Repaint);
            ...
            if (candraw.Contains(spriteDeformerEditor.currentTool))
                Handles.ArrowHandleCap(15, pos2Dto3D(pivot), spriteDeformerEditor.spriteDeformer.transform.rotation * Quaternion.Euler(-90 - oriant * Mathf.Rad2Deg, 90, 0), newHandleSize, EventType.Repaint);

            Handles.color = nextTool == CurrentTool.MOVE_POINTS ? overColor : standartColor;
            Handles.CylinderHandleCap(15, pos2Dto3D(pivot), spriteDeformerEditor.spriteDeformer.transform.rotation, newHandleSize / 5f, EventType.Repaint);
            ...
            if (candraw.Contains(spriteDeformerEditor.currentTool))
                Handles.SphereHandleCap(0, pos2Dto3D(newPivotHandle), Quaternion.identity, newHandleSize / 10f, EventType.Repaint);
            ...
            if (candraw.Contains(spriteDeformerEditor.currentTool))
                Handles.CubeHandleCap(0, pos2Dto3D(newScaleHorizontalHandle), spriteDeformerEditor.spriteDeformer.transform.rotation * Quaternion.Euler(0, 0, oriant * Mathf.Rad2Deg), newHandleSize / 7f, EventType.Repaint);
            ...
            if (candraw.Contains(spriteDeformerEditor.currentTool))
                Handles.CubeHandleCap(0, pos2Dto3D(newScaleVerticalHandle), spriteDeformerEditor.spriteDeformer.transform.rotation * Quaternion.Euler(0, 0, oriant * Mathf.Rad2Deg), newHandleSize / 7f, EventType.Repaint);

            Handles.color = nextTool == CurrentTool.ORIANT ? overColor : standartColor;
            candraw = new List<CurrentTool>() { CurrentTool.NONE, CurrentTool.ORIANT, CurrentTool.MOVE_PIVOT, CurrentTool.MOVE_PIVOT };
            if (candraw.Contains(spriteDeformerEditor.currentTool))
                Handles.ConeHandleCap(0, pos2Dto3D(newOriantHandle), Quaternion.LookRotation(pos2Dto3D(newOriantHandle) - pos2Dto3D(pivot)), newHandleSize / 6f, EventType.Repaint);
            ...
            if (candraw.Contains(spriteDeformerEditor.currentTool))
                Handles.ConeHandleCap(0, pos2Dto3D(newRotateHandle), Quaternion.LookRotation(pos2Dto3D(newOriantHandle) - pos2Dto3D(pivot)), newHandleSize / 6f, EventType.Repaint);
        }
