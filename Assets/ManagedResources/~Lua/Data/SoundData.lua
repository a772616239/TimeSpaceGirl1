SoundConfig = {
    BGM_Main = "cn2-x1_battle_BGM_SpyStory",
    BGM_Shop = "cn2-x1_battle_BGM_Arcade",
    BGM_MapChoose = "n1_bgm_boss",--没用
    BGM_MainMenu = "n1_bgm_tour",--没用
    BGM_WorkShop = "n1_bgm_camp",--没用
    BGM_Login = "cn2-x1_battle_BGM_Badrobots",
    BGM_Battle_2 = "n1_bgm_tour",
    BGM_DiffMonster = "n1_bgm_boss",--没用
    BGM_Recruit = "n1_bgm_tour",--没用
    BGM_Rank = "cn2-x1_battle_BGM_PercussionLoop",
    BGM_Player = "n1_bgm_tour",--没用
    BGM_Adventure = "cn2-x1_bgm_prewar",--没用
    BGM_Carbon = "cn2-x1_battle_BGM_Mechanic",
    BGM_CarbonMap = "cn2-x1_battle_BGM_NightCity",
    BGM_Arena = "cn2-x1_battle_BGM_NightCity",
    BGM_Guild = "cn2-x1_battle_BGM_EpicBattleLoop",
    BGM_GuildFight = "cn2-x1_bgm_prewar",
    BGM_Battle_1 = "cn2-x1_battle_BGM_LetsRock",
    
    BGM_Story_1 = "cn2-x1_bgm_prewar",
    ...
    Sound_BattleWin = "cn2-x1_ui_sound_battle_win",
    Sound_BattleLose = "cn2-x1_ui_sound_battle_lose",
    ...
    Sound_Recruit_Anim = "cn2-x1_ui_Lottery_Show",--抽卡动画
    Sound_Recruit_GetHero_1 = "cn2-x1_ui_Lottery_HeroShow_01",--获得1-3星
    Sound_Recruit_GetHero_2 = "cn2-x1_ui_Lottery_HeroShow_02",--获得4星
    Sound_Recruit_GetHero_3 = "cn2-x1_ui_Lottery_HeroShow_03",--获得5星

    Sound_FootStep = "Footsteps_Run_0", --1-7随机播放

    Sound_UICancel = "n1_ui_sound_refresh_click",
    Sound_UIClick = "cn2-x1_ui_sound_normal_click",
    ...
    Ambient_Login = "cn2-x1_amb_login",
