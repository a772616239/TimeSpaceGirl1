...
public class Packager
{
    ...
    public static void EncodeLuaFile(string srcFile, string outFile)
    {
        ...
        UnityEngine.Debug.Log("srcFile:"+srcFile);
        UnityEngine.Debug.Log("outFile:"+outFile);
        ...
        if (Application.platform == RuntimePlatform.WindowsEditor)
        {
            ...
            // 64位luagit
            string outFile_64 = outFile.Replace(".bytes", "_x64.bytes");// 文件名后缀添加64
            args = "-b " + srcFile + " " + outFile_64;
        ...
        else if (Application.platform == RuntimePlatform.OSXEditor)
        {
            ...
            // exedir = AppDataPath.Replace("assets", "") + "LuaEncoder/luajit_mac/32/";
            ...
            //64位luagit
            string outFile_64 = outFile.Replace(".bytes", "_64.bytes");// 文件名后缀添加64
            args = "-b " + srcFile + " " + outFile_64;
            exedir = AppDataPath.Replace("assets", "") + "LuaEncoder/luajit_mac/64/";
            luaexe = exedir + "luajit";
            ProcessStartInfo info_x64 = new ProcessStartInfo();
            info_x64.FileName = luaexe;
            info_x64.Arguments = args;
