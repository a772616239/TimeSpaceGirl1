...
public class Colorful_BleachBypassWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Colorful.BleachBypass), typeof(Colorful.BaseEffect));
	...
	static int get_Amount(IntPtr L)
	{
		...
		try
		{
			...
			Colorful.BleachBypass obj = (Colorful.BleachBypass)o;
