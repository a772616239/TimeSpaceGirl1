...
public class Colorful_CrossStitchWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Colorful.CrossStitch), typeof(Colorful.BaseEffect));
	...
	static int get_Size(IntPtr L)
	{
		...
		try
		{
			...
			Colorful.CrossStitch obj = (Colorful.CrossStitch)o;
			int ret = obj.Size;
