...
public class Colorful_DitheringWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Colorful.Dithering), typeof(Colorful.BaseEffect));
		L.RegFunction("__eq", op_Equality);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.RegVar("ShowOriginal", get_ShowOriginal, set_ShowOriginal);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_ShowOriginal(IntPtr L)
	{
		object o = null;
		...
		try
		{
			...
			Colorful.Dithering obj = (Colorful.Dithering)o;
			bool ret = obj.ShowOriginal;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index ShowOriginal on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_ShowOriginal(IntPtr L)
	{
		object o = null;
