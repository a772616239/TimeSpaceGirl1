...
public class Colorful_PixelateWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Colorful.Pixelate), typeof(Colorful.BaseEffect));
	...
	static int get_Scale(IntPtr L)
	{
		...
		try
		{
			...
			Colorful.Pixelate obj = (Colorful.Pixelate)o;
			float ret = obj.Scale;
	...
	static int get_Mode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Colorful.Pixelate obj = (Colorful.Pixelate)o;
			Colorful.Pixelate.SizeMode ret = obj.Mode;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int set_Mode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Colorful.Pixelate obj = (Colorful.Pixelate)o;
			Colorful.Pixelate.SizeMode arg0 = (Colorful.Pixelate.SizeMode)ToLua.CheckObject(L, 2, typeof(Colorful.Pixelate.SizeMode));
			obj.Mode = arg0;
			return 0;
		}
		catch(Exception e)
