...
public class Colorful_TechnicolorWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Colorful.Technicolor), typeof(Colorful.BaseEffect));
	...
	static int get_Exposure(IntPtr L)
	{
		...
		try
		{
			...
			Colorful.Technicolor obj = (Colorful.Technicolor)o;
			float ret = obj.Exposure;
			LuaDLL.lua_pushnumber(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index Exposure on a nil value");
		}
	}
	...
	static int get_Balance(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Colorful.Technicolor obj = (Colorful.Technicolor)o;
			UnityEngine.Vector3 ret = obj.Balance;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
