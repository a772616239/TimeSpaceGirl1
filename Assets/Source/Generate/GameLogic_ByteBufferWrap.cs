...
public class GameLogic_ByteBufferWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(GameLogic.ByteBuffer), typeof(System.Object));
		L.RegFunction("Close", Close);
		L.RegFunction("WriteByte", WriteByte);
		L.RegFunction("WriteInt", WriteInt);
		L.RegFunction("WriteIntToByte", WriteIntToByte);
		...
		L.RegFunction("ReadIntToByte", ReadIntToByte);
		...
		L.RegFunction("DataByte", DataByte);
		L.RegFunction("ToBytes", ToBytes);
		L.RegFunction("Flush", Flush);
		L.RegFunction("New", _CreateGameLogic_ByteBuffer);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateGameLogic_ByteBuffer(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				GameLogic.ByteBuffer obj = new GameLogic.ByteBuffer();
			...
			else if (count == 1)
			{
				...
				GameLogic.ByteBuffer obj = new GameLogic.ByteBuffer(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: GameLogic.ByteBuffer.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Close(IntPtr L)
	{
		try
		{
			...
			GameLogic.ByteBuffer obj = (GameLogic.ByteBuffer)ToLua.CheckObject<GameLogic.ByteBuffer>(L, 1);
			obj.Close();
			return 0;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int WriteIntToByte(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ReadIntToByte(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			GameLogic.ByteBuffer obj = (GameLogic.ByteBuffer)ToLua.CheckObject<GameLogic.ByteBuffer>(L, 1);
			int o = obj.ReadIntToByte();
			LuaDLL.lua_pushinteger(L, o);
			return 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int DataByte(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			GameLogic.ByteBuffer obj = (GameLogic.ByteBuffer)ToLua.CheckObject<GameLogic.ByteBuffer>(L, 1);
			LuaInterface.LuaByteBuffer o = obj.DataByte();
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
