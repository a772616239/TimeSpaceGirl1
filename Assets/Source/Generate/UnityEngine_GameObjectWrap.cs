...
public class UnityEngine_GameObjectWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("ShowByXScale", ShowByXScale);
		L.RegFunction("HideByXScale", HideByXScale);
		L.RegFunction("SetActiveByScale", SetActiveByScale);
	...
	static int SetLayer(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.GameObject.SetLayer");
			}
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ShowByXScale(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int HideByXScale(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int SetActiveByScale(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
