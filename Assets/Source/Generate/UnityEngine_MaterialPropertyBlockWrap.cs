...
public class UnityEngine_MaterialPropertyBlockWrap
{
	...
	static int CopySHCoefficientArraysFrom(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<UnityEngine.Rendering.SphericalHarmonicsL2[]>(L, 2))
			{
				UnityEngine.MaterialPropertyBlock obj = (UnityEngine.MaterialPropertyBlock)ToLua.CheckObject(L, 1, typeof(UnityEngine.MaterialPropertyBlock));
			...
			else if (count == 2 && TypeChecker.CheckTypes<System.Collections.Generic.List<UnityEngine.Rendering.SphericalHarmonicsL2>>(L, 2))
			{
				UnityEngine.MaterialPropertyBlock obj = (UnityEngine.MaterialPropertyBlock)ToLua.CheckObject(L, 1, typeof(UnityEngine.MaterialPropertyBlock));
	...
	static int CopyProbeOcclusionArrayFrom(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes<System.Collections.Generic.List<UnityEngine.Vector4>>(L, 2))
			{
				UnityEngine.MaterialPropertyBlock obj = (UnityEngine.MaterialPropertyBlock)ToLua.CheckObject(L, 1, typeof(UnityEngine.MaterialPropertyBlock));
