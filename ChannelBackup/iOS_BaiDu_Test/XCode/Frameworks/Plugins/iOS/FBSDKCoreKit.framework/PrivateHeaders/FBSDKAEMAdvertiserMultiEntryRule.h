...
@interface FBSDKAEMAdvertiserMultiEntryRule : NSObject<FBSDKAEMAdvertiserRuleMatching, NSCopying, NSSecureCoding>

@property (nonatomic, readonly, assign) FBSDKAEMAdvertiserRuleOperator operator;

@property (nonatomic, readonly) NSArray<id<FBSDKAEMAdvertiserRuleMatching>> *rules;
